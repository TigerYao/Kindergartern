...
package com.opencv.tigeryao.arcmenu;
...
public class ArcMenu extends RelativeLayout {
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            int drawID = a.getResourceId(R.styleable.ArcLayout_main_img,R.drawable.composer_icn_plus);
            mHintView.setImageResource(drawID);
            a.recycle();
        }
    }
    ...
    private static Animation createItemDisapperAnimation(final long duration, final boolean isClicked) {
        ...
        animationSet.addAnimation(new AlphaAnimation(isClicked?0.0f:1.0f, isClicked?1.0f:0.0f));
