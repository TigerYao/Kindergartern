        ...
        switch (e.getTipsType()){
            ...
            case Join:
                ...
                return stringBuilder +
                        BaseApplication.getContext().getString(R.string.summary_group_mem_add);
            case Kick:
                return e.getUserList().get(0) +
                        BaseApplication.getContext().getString(R.string.summary_group_mem_kick);
            case ModifyMemberInfo:
                ...
                return stringBuilder +
                        BaseApplication.getContext().getString(R.string.summary_group_mem_modify);
            case Quit:
                return e.getOpUser() +
                        BaseApplication.getContext().getString(R.string.summary_group_mem_quit);
