package com.junbaole.kindergartern.data.utils.zxing;
...
import com.junbaole.kindergartern.data.utils.zxing.camera.CameraManager;
import com.junbaole.kindergartern.data.utils.zxing.decode.DecodeThread;
import com.junbaole.kindergartern.data.utils.zxing.decode.PhotoScanHandler;
import com.junbaole.kindergartern.data.utils.zxing.decode.RGBLuminanceSource;
import com.junbaole.kindergartern.data.utils.zxing.utils.BeepManager;
import com.junbaole.kindergartern.data.utils.zxing.utils.BitmapUtil;
import com.junbaole.kindergartern.data.utils.zxing.utils.CaptureActivityHandler;
...
public class ScanManager implements SurfaceHolder.Callback {
    public static final String SCAN_ERROR = "未能识别二维码，请重新扫描";
    ...
    private boolean isContinuousExecute;
...
//		inactivityTimer.shutdown();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        tempHolder = holder;
        if (isContinuousExecute) {
            noticateStartInitCamera();
            isContinuousExecute = false;
        }
    }

    public void setCanContinuousExecute() {
        isContinuousExecute = true;
    }

    public void noticateStartInitCamera() {
        if (tempHolder != null && !isHasSurface) {
            isHasSurface = true;
            initCamera(tempHolder);
            scanLine.setVisibility(View.VISIBLE);
//            scanCropView.setBackgroundResource(R.drawable.bg_frame);
            if (animation != null) ScanManager.this.scanLine.startAnimation(animation);
        }
    }
...
//				Log.e("hongliang1", "handler new成功！:"+handler);
            ...
            Log.e(TAG, "camera", ioe);
            //弹出提示，报错
            ioe.printStackTrace();
            listener.scanError(new Exception("摄像头权限已被禁用，请打开后重新尝试！"));
...
//	    beepManager.playBeepSoundAndVibrate();
    ...
    public void scanningImage(final String photo_path2) {
        if (TextUtils.isEmpty(photo_path2)) {
            listener.scanError(new Exception("未能识别二维码，请重新扫描"));
        }
...
//				Hashtable<DecodeHintType, String> hints = new Hashtable<DecodeHintType, String>();
                ...
                try {
                    ...
                    msg.obj = new Exception(SCAN_ERROR);
                    photoScanHandler.sendMessage(msg);
                }
            }
        }).start();
