...
public class ContactsSectionIndexer implements SectionIndexer {
	...
	public ContactsSectionIndexer(List<ContactListView.ContactItemInterface> contacts) {
...
//		}
	...
	public void initPositions(List<ContactListView.ContactItemInterface> contacts)  {
		...
		for(ContactListView.ContactItemInterface contact: contacts){
