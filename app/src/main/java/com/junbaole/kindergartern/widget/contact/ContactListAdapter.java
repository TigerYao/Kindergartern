...
public class ContactListAdapter extends ArrayAdapter<ContactListView.ContactItemInterface>{
	...
	public ContactListAdapter(Context _context, int _resource, List<ContactListView.ContactItemInterface> _items) {
	...
	public void showSectionViewIfFirstItem(View rowView, ContactListView.ContactItemInterface item, int position){
	...
	public void populateDataForRow(View parentView, ContactListView.ContactItemInterface item , int position){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ContactListView.ContactItemInterface item = getItem(position);
